...
public class GatherLootTable : LootTable,IInteractable
{
    ...
    {
        Player.Instance.Gather(SpellBook.Instance.GetSpell("Gather"), MyDroppedItems);
        LootWindow.Instance.MyInteractable = this;
    }

    public void StopInteract()
    {
        LootWindow.Instance.MyInteractable = null;
